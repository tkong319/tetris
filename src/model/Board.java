...
public final class Board extends Observable {
    ...
    /**
     * The boolean representing the pause status of the game.
     */
    ...
    /**
     * Changes the pause status of game.
     */
    ...
    /**
     * Changes the game over status to true.
     */
    ...
    private void clearLines() {
        for (int i = myFrozenBlocks.size() - 1; i >= 0; i--) {
            ...
            if (clear) {
                ...
                setChanged();
                notifyObservers(myFrozenBlocks); //Passes the list of frozen blocks to 
                                                 //the observers so when observers are 
                                                 //notified, they can keep track of lines
                                                 //cleared.
            }
        }
    }
